...
created: 2026-06-02
updated: 2026-06-04
related: ["[[seo]]", "[[brand-data]]", "[[winter-services]]", "[[service-pages]]", "[[ogrodowe-abc]]", "[[realizacje]]", "[[app-shell]]"]
...
`SiteHeader`/`SiteFooter` now also wrap the auth screens via the `(public)/(auth)` layout (see [[auth-portal]], [[app-shell]]).
